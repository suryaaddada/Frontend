...
export const NurseRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let url="https://localhost:44331/api/Nurse";
      let emailExistsUrl=`https://localhost:44331/api/Login/nursemailexists/${email}`;
